...
These are the numbers the Phase 1 test checks.

| Goal | Target | In plain words |
|---|---|---|
| Lag | Under ~20–30 ms from hand move to cursor move | Feels attached to your hand |
...
1. **Lag:** film your hand and the screen together in 240 fps slow motion, then count frames
   between your hand moving and the cursor moving.
...
**How we pick the winner:** the sensor + position that comes closest to your normal mouse on
accuracy, while staying under the lag and shake targets.
